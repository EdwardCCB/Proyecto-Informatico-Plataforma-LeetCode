      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        <!-- <Popover class="relative">
          ...
          <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
            <PopoverPanel class="absolute top-full -left-50 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5">
              <div class="p-4">
        ...
        <RouterLink to="/Home" class="text-sm/6 font-semibold text-gray-900">Home</RouterLink>
        <RouterLink to="/Problems" class="text-sm/6 font-semibold text-gray-900">Problems</RouterLink>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <RouterLink to="/Home" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Home</RouterLink>
              <RouterLink to="/Problems" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Problems</RouterLink>
              <!-- <RouterLink to="/" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Company</RouterLink> -->
            </div>
            <div class="py-6">
...
const hideAuthLinks = ['/login', '/register'].includes(route.currentRoute.value.path)
